...
Estrutura EXATA do JSON:
{
  ...
  try {
    ...
    $app.save(record)
    $app.logger().info('Cron lottery fetch success', 'date', data.data_consulta)
  } catch (err) {
    $app.logger().error('Cron lottery fetch failed', 'error', err.message)
  }
})
